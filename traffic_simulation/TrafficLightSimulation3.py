...
from DefaultCountdownTraffic1and3 import green_traffic_up_right_countdown, green_traffic_left_countdown, yellow_traffic_countdown
from DefaultCountdownTraffic2and4 import red_traffic_countdown

def traffic_light_simulation_3():
    # Create the main application window
    root = tk.Tk()
    root.title("Traffic Light 3")
